...
function dropItems(idOfDraggedItem,targetId,x,y)
{
	...
	if(numericIdTarget-numericIdSource==100){	// In the html above, there's a difference in 100 between the id of the country and it's capital(example:
		modify_qty(1,1);								// Oslo have id "box1" and Norway have id "box101", i.e. 1 + 100.
...
dragDropObj.addSource('box10',true);	// Make <div id="box4"> dragable. slide item back into original position after drop
